...
internal static class UsersLoggerExtensions
{
    ...
    static UsersLoggerExtensions()
    {
        _userSigningInAs = LoggerMessage.Define<string?>(
            LogLevel.Debug,
            new EventId(Infrastructure.LoggerEventIdCodes.EndpointsUsersSigningInAs, nameof(UserSigningInAs)),
            "Signing in as '{Username}'");

        _userGetCurrentUserInfo = LoggerMessage.Define<int>(
            LogLevel.Debug,
            new EventId(Infrastructure.LoggerEventIdCodes.EndpointsUsersGetCurrentUser, nameof(UserGetCurrentUserInfo)),
