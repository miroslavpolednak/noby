    ...
    : IRequestHandler<UpdateParametersRequest>
{
    public async Task Handle(UpdateParametersRequest request, CancellationToken cancellationToken)
    {
        ...
        if (request.Parameters is not null)
        {
            ...
            switch ((CIS.Foms.Enums.SalesArrangementTypes)saInstance.SalesArrangementTypeId)
            {
                case CIS.Foms.Enums.SalesArrangementTypes.Mortgage:
                ...
                case CIS.Foms.Enums.SalesArrangementTypes.Drawing:
                ...
                case CIS.Foms.Enums.SalesArrangementTypes.GeneralChange:
                ...
                case CIS.Foms.Enums.SalesArrangementTypes.HUBN:
                ...
                case CIS.Foms.Enums.SalesArrangementTypes.CustomerChange:
                ...
                case CIS.Foms.Enums.SalesArrangementTypes.CustomerChange3602A:
                ...
                case CIS.Foms.Enums.SalesArrangementTypes.CustomerChange3602B:
                ...
                case CIS.Foms.Enums.SalesArrangementTypes.CustomerChange3602C:
