...
internal static class ModelComparers
{
    ...
    public static void CompareRoot(UpdateDetailWithChangesRequest request, UpdateDetailWithChangesRequest original, dynamic delta)
    {
    ...
    static ModelComparers()
    {
        ...
        // root
        _rootCompareLogic.Config.IgnoreProperty<UpdateDetailWithChangesRequest>(x => x.CustomerOnSAId);
