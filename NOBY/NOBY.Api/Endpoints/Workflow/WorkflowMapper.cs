...
public class WorkflowMapper
{
    ...
    private static WorkflowTask Map(_Case.WorkflowTask task, DomainServices.CodebookService.Contracts.v1.WorkflowTaskStatesNobyResponse.Types.WorkflowTaskStatesNobyItem taskState) => new()
    {
        TaskId = task.TaskId,
