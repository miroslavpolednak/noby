...
CREATE DATABASE [NOBY]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'NOBY', FILENAME = N'F:\MSSQL15.UAT1\MSSQL\DATA\NOBY.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'NOBY_log', FILENAME = N'G:\MSSQL15.UAT1\MSSQL\Data\NOBY_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
