...
CREATE DATABASE [NOBY]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'NOBY', FILENAME = N'S:\Data_Silver_18_SQL\NOBY.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'NOBY_log', FILENAME = N'S:\Data_Silver_16_SQL\NOBY_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
