...
CREATE DATABASE [NobyAudit]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'NobyAudit', FILENAME = N'F:\MSSQL15.SIT\MSSQL\DATA\NobyAudit.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'NobyAudit_log', FILENAME = N'G:\MSSQL15.SIT\MSSQL\Data\NobyAudit_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
