...
CREATE DATABASE [NobyAudit]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'NobyAudit', FILENAME = N'R:\Data_Bronze_12_PP\NobyAudit.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'NobyAudit_log', FILENAME = N'R:\Data_Silver_07_PP\NobyAudit_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
