...
internal sealed class WorkflowMapperServiceOld
    : IWorkflowMapperServiceOld
{
    ...
    public WorkflowMapperServiceOld(ICodebookServiceClient codebookService, ICurrentUserAccessor userAccessor)
    {
