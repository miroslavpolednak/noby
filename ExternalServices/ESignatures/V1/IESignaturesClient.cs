    ...
    : IExternalServiceClient
{
    ...
    /// <exception cref="CisExternalServiceResponseDeserializationException">Nepodařilo se deserializovat JSON response služby do očekávaného objektu</exception>
    /// <exception cref="CisExternalServiceValidationException">Code=50001; Služba vrátila korektní result, nicméně Status není v našem enumu.</exception>
    /// <exception cref="CisExternalServiceValidationException">Code=?; Služba vrátila chybový stav indikovaný vlastností Code. Exception má v tomto případě Code takový, jaký se vrátil z API, stejně tak jako Message.</exception>
    ...
    /// <exception cref="CisExternalServiceValidationException">Code=50005; Response neobsahuje binární data</exception>
    ...
    /// <exception cref="CisExternalServiceValidationException">Code=50002,50003; Pokud některé z číselníkových ID nebylo v daném číselníku nalezeno</exception>
    /// <exception cref="CisExternalServiceValidationException">Code=50004; ReferenceId not found in response</exception>
    /// <exception cref="CisExternalServiceValidationException">Code=?; Služba vrátila chybový stav indikovaný vlastností Code. Exception má v tomto případě Code takový, jaký se vrátil z API, stejně tak jako Message.</exception>
