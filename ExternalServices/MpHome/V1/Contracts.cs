...
namespace ExternalServices.MpHome.V1.Contracts
{
    ...
    public partial class LoanDetail
    {
        ...
        public System.Collections.Generic.ICollection<LoanRealEstate>? RealEstates { get; set; } = default!;

        [System.Text.Json.Serialization.JsonPropertyName("purposes")]
        public System.Collections.Generic.ICollection<LoanPurpose>? Purposes { get; set; } = default!;

        [System.Text.Json.Serialization.JsonPropertyName("obligations")]
        public System.Collections.Generic.ICollection<LoanObligation>? Obligations { get; set; } = default!;

        [System.Text.Json.Serialization.JsonPropertyName("loanRelationships")]
        public System.Collections.Generic.ICollection<LoanRelationship>? LoanRelationships { get; set; } = default!;
