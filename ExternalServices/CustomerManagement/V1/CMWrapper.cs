...
namespace ExternalServices.CustomerManagement.V1.CMWrapper
{
    ...
    public partial class Client 
    {
        ...
        /// <summary>getCustomerBaseInfo</summary>
        ...
        /// <summary>getCustomersBaseInfo - for list of IDs</summary>
        ...
        /// <summary>searchCustomer</summary>
        ...
        /// <returns>Search result</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<CustomerSearchResult> SearchCustomerAsync(int? numberOfEntries, long? customerId, string name, string firstName, System.DateTime? birthEstablishedDate, string identifierValue, string identifierTypeCode, string idDocumentTypeCode, string idDocumentNumber, string idDocumentIssuingCountryCode, string email, string phoneNumber, bool? isInKbi, System.Collections.Generic.IEnumerable<Anonymous> legalStatusCode, bool? includeArchived, bool? showSegment, string x_B3_TraceId, string x_KB_Party_Identity_In_Service, string x_KB_Orig_System_Identity, string x_KB_Caller_System_Identity, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
        ...
        /// <summary>getNaturalPersonPersonalData</summary>
        /// <param name="customerId">Identifier of the customer whose base information will be returned (KBID - identifier of customer in Customer Management system)</param>
        /// <param name="showFirstNameVocative">flag indicating whether first name vocative should be evalueted and returned</param>
        /// <param name="showSurnameVocative">flag indicating whether surname vocative should be evalueted and returned</param>
        /// <param name="x_B3_TraceId">[Trace Id](https://wiki.kb.cz/confluence/pages/viewpage.action?pageId=217274116#Komunika%C4%8Dn%C3%ADhlavi%C4%8Dkyverze2REST-TraceId)</param>
    ...
    /// <summary>Customer base information entity - contains party, primary address, contact address, primary phone and email, customer segments and economic classifications.</summary>
    ...
    public partial class CustomerBaseInfo
    {
        ...
        /// <summary>Flag indicating that customer is legally incapable. Only for Natural Person</summary>
        ...
        /// <summary>Flag indicating that customer is insurable</summary>
        ...
        /// <summary>Economic sector code according to ESA2010 as amended by the CNB - RDM codebook CB_ESAInstitutionalSectorCNB</summary>
        ...
        /// <summary>Code of economic activity according to the new classification of economic activities Only for Juridical Person - RDM codebook CB_NACECode</summary>
    ...
    /// <summary>Abstract type of party. Real descendants are NaturalPerson, LegalPerson and Entrepreneur</summary>
    ...
    {
        /// <summary>Flag indicating whether subject is in KBI system</summary>
        ...
        /// <summary>List of customer identifiers</summary>
        ...
        /// <summary>P - for Natural Person, E - for Entrepreneur, B - for Legal Person</summary>
    ...
    /// <summary>Party of typ Legal Person</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]

    public partial class LegalPerson : Party
    {
        /// <summary>Company name. Is filled with name from business register. When name from business register does not exists, KB custom search name is used instead.</summary>
        [Newtonsoft.Json.JsonProperty("name", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.StringLength(200, MinimumLength = 1)]
        public string Name { get; set; }

        /// <summary>Company name. Name from business register.</summary>
        ...
        /// <summary>Custom KB search name</summary>
        ...
        /// <summary>Company established date</summary>
        ...
        /// <summary>Czech identification number</summary>
    ...
    /// <summary>Party of typ Entrepreneur</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]

    public partial class Entrepreneur : Party
    {
        /// <summary>Entrepreneur name. Is filled with name from business register. When name from business register does not exists, KB custom search name is used instead.</summary>
        [Newtonsoft.Json.JsonProperty("name", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.StringLength(200, MinimumLength = 1)]
        public string Name { get; set; }

        /// <summary>Entrepreneur name. Name from business register.</summary>
        [Newtonsoft.Json.JsonProperty("businessRegisterName", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.StringLength(200, MinimumLength = 1)]
        public string BusinessRegisterName { get; set; }
        ...
        /// <summary>Entrepreneur established date</summary>
        [Newtonsoft.Json.JsonProperty("establishedOn", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(DateFormatConverter))]
        public System.DateTime EstablishedOn { get; set; }
    ...
    /// <summary>Party type of Natural Person</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]

    public partial class NaturalPerson : Party
    {
        /// <summary>Title before name, i.e. prof. Ing., gen. Ing.</summary>
        ...
        /// <summary>Place of birth, i.e. Praque</summary>
        ...
        /// <summary>Land of birth - ISO 2 character code - RDM codebook CB_Country</summary>
        ...
        /// <summary>List of customer citizenships</summary>
        ...
        /// <summary>Gender. KB supports only two genders - MALE and FEMALE</summary>
        ...
        /// <summary>Czech birth number</summary>
        ...
        /// <summary>First name vocative</summary>
        ...
        /// <summary>Surname vocative</summary>
        ...
        /// <summary>Marital status code, RDM codebook CB_MaritalStatus</summary>
    ...
    public partial class JuridicalPersonLegalForm
    {
        ...
        /// <summary>Description of legal form in the case of unknown legal form</summary>
    ...
    {
        /// <summary>Legal capacity restriction type</summary>
        ...
        /// <summary>End date of the restriction</summary>
    ...
    /// <summary>Customers identifiers</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]

    public partial class CustomerIdentifier
    {
        /// <summary>Identifier type code. RDM codebook CB_JuridicalPersonIdentificationType</summary>
        ...
        /// <summary>Value of identifier</summary>
    ...
    public partial class IdentificationDocument
    {
        ...
        /// <summary>Official number of identification document - CDM number</summary>
        ...
        /// <summary>Identification document issuing authority</summary>
        ...
        /// <summary>When document was issued - CDM validFrom</summary>
        ...
        /// <summary>Document is valid until this date</summary>
        ...
        /// <summary>Registration in OR or other register</summary>
        ...
        /// <summary>The document expiration flag</summary>
        ...
        /// <summary>Losted document flag</summary>
    ...
    /// <summary>Customer primary phone.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]

    public partial class PrimaryPhone
    {
        /// <summary>Local part of phone number, including national destination code i.e. +420 777112233.</summary>
        ...
        /// <summary>Flag whether it is a mobile phone. Flag is determined only for czech and slovak phone numbers.</summary>
        ...
        /// <summary>Flag indicating that phone is confirmed by client</summary>
    ...
    /// <summary>Customer primary phone confirmed by customer.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]
    [System.Obsolete]
    ...
    /// <summary>Customer primary email.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]
    ...
    /// <summary>Primary address. if query parameter showLineAddress is set to true (default value is true) the address is returned. if query parameter showComponentAddress is set to true the componentAddress is returned.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]
    ...
    public partial class PrimaryAddress
    {
        ...
        /// <summary>For natural person place of residence - date when customer starts live there</summary>
    ...
    /// <summary>Contact address. Bank correspondence delivery address. If it is not filled out, correspondence is delivered to a permanent residence address. A contact address can also be entered as a P.O. BOX. if query parameter showLineAddress is set to true (default value is true) the address is returned. if query parameter showComponentAddress is set to true the componentAddress is returned.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]
    ...
    public partial class ContactAddress
    {
        ...
        /// <summary>Flag indicating that address is confirmed by client</summary>
        [Newtonsoft.Json.JsonProperty("confirmed", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool Confirmed { get; set; }
    ...
    /// <summary>Temporary residence address. The address is obligatory for foreigners who do not have the Czech Republic filled in at their permanent address. if query parameter showLineAddress is set to true (default value is true) the address is returned. if query parameter showComponentAddress is set to true the componentAddress is returned.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]
    ...
    {
        /// <summary>First line of address (street, street number etc.)</summary>
        ...
        /// <summary>Address delivery details</summary>
        ...
        /// <summary>Third line of address (typically city)</summary>
        [Newtonsoft.Json.JsonProperty("city", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.ComponentModel.DataAnnotations.StringLength(100)]
        public string City { get; set; }

        /// <summary>Post code, Postal code, ZIP code</summary>
        ...
        /// <summary>Identification of address point</summary>
    ...
    /// <summary>Component address. Examples: &lt;ul&gt; &lt;li&gt; Czech address with street, house number and street number: { "street": "Wilsonova", "houseNumber": "101", "streetNumber": "1", "cityDistrict": "Vinohrady", "pragueDistrict": "Praha 1", "deliveryDetails": "Marketing department", "city": "Praha", "postCode": "11000", "countryCode": "CZ", "addressPointId": "21727554" }
    ...
    /// <br/>&lt;li&gt; Post box address: { "postBox": "1234 ", "city": "Jenštejn ", "postCode": "25091", "countryCode": "CZ", } &lt;/ul&gt; </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]

    public partial class ComponentAddress
    {
        /// <summary>Street name without a house number. The field is not filled out for cities without an street network or for post box address.</summary>
        [Newtonsoft.Json.JsonProperty("street", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.StringLength(100)]
        public string Street { get; set; }

        /// <summary>The house number. It is not filled out for post box address. Foreign addresses should have it filled out. Czech addresses may have the building number in this attribute or the evidenceNumber.</summary>
        ...
        /// <summary>Evidence number. It is not filled out for post box address. Used only for Czech addresses. The evidence number has objects that are not assigned a house number. These are, for example, chalets.</summary>
        ...
        /// <summary>Street number. It is not filled out for post box address. Used only for Czech and Slovak addresses. A number that helps locate a house on a given street.</summary>
        ...
        /// <summary>City district. It is not filled out for post box address. Should be filled for all Czech addresses, at least for that with address point id.</summary>
        ...
        /// <summary>Territory of the city district in the capital Prague (Praha 1 - 10 not Praha 1 - 22). It is not filled out for post box address.</summary>
        ...
        /// <summary>A note of delivery specifying to whom delivery is intended.</summary>
        [Newtonsoft.Json.JsonProperty("deliveryDetails", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.StringLength(100)]
        public string DeliveryDetails { get; set; }

        /// <summary>The city name. Only the name of the city without its parts is given, i.e. for Prague we only mention Prague and not Prague 6 or Prague Dejvice.</summary>
        [Newtonsoft.Json.JsonProperty("city", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.ComponentModel.DataAnnotations.StringLength(100)]
        public string City { get; set; }

        /// <summary>P.O. Box number. For Czech addresses the value is number. It is filled out for post box address.</summary>
        ...
        /// <summary>Post code, Postal code, ZIP code.  For czech address it should be five-digit number between 10000 - 79999</summary>
        [Newtonsoft.Json.JsonProperty("postCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.ComponentModel.DataAnnotations.StringLength(16)]
        public string PostCode { get; set; }

        /// <summary>It is used only for foreign addresses and mainly for states which are divided into large self-governing entities. E.g. USA, then state like Texas, Florida is filled out.</summary>
        ...
        /// <summary>Address point id from Register of Territorial Identification of Addresses and Properties in the Czech Republic or its equivalent in the Slovak Republic.</summary>
        [Newtonsoft.Json.JsonProperty("addressPointId", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.StringLength(100)]
        public string AddressPointId { get; set; }
    ...
    /// <summary>Types of the address format.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]
    ...
    /// <summary>Customer segment and subsegment</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]

    public partial class CustomerSegment
    {
        /// <summary>Synthetic segment key code (connection of segmentCode + subsegmentCode) for referencing RDM codebook CB_CustomerSegment</summary>
        ...
        /// <summary>Customer subsegment</summary>
    ...
    public partial class NaturalPersonPersonalData
    {
        ...
        /// <summary>Subject initials from first name and surname</summary>
    ...
    {
        /// <summary>Flag indicating whether search result can return more rows</summary>
    ...
    public partial class CustomerSearchResultRow
    {
        ...
        /// <summary>Customer of bank to which access is restricted. For example, an employee is considered to be restricted.</summary>
    ...
    /// <summary>Abstract Party search result. Common ancestor for Natural Person, Legal Person and Entrepreneur</summary>
    [Newtonsoft.Json.JsonConverter(typeof(JsonInheritanceConverter), "objectType")]
    ...
    /// <summary>Legal Person search result</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]
    ...
    public partial class LegalPersonSearchResult : PartySearchResult
    {
        ...
        /// <summary>Custom KB search name. This field is used for searching.</summary>
        [Newtonsoft.Json.JsonProperty("nameKb", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Required]
        [System.ComponentModel.DataAnnotations.StringLength(200, MinimumLength = 1)]
        public string NameKb { get; set; }
    ...
    /// <summary>Entrepreneur search result</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]
    ...
    /// <summary>Natural Person search result</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]
    ...
    /// <summary>The customer's identification entity. Entity contains method, identificaiton date and identifying company.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]

    public partial class CustomerIdentification
    {
        /// <summary>Code of the method of identifying the subject. Value is defined in the code list CB_IdentificationMethodType</summary>
        ...
        /// <summary>The date and time the subject was first identified.</summary>
        ...
        /// <summary>Czech identification number of the company that made the subject identification. Value is mandatory only for specific identification method codes. See CB_IdentificationMethodType.</summary>
        [Newtonsoft.Json.JsonProperty("czechIdentificationNumber", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.StringLength(30, MinimumLength = 1)]
        public string CzechIdentificationNumber { get; set; }
    ...
    /// <summary>FATCA (Foreign Account Tax Compliance Act)</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]

    public partial class Fatca
    {
        /// <summary>FATCA status code - RDM codebook CB_FATCAStatus</summary>
        ...
        /// <summary>Date of FATCA status determination</summary>
    ...
    /// <summary>Customer turnover in one year</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]

    public partial class CustomerTurnover
    {
        /// <summary>Year of turnover</summary>
        ...
        /// <summary>Customer turnover per year</summary>
    ...
    /// <summary>Customer financial profile</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]
    ...
    public partial class FinancialProfile
    {
        ...
        /// <summary>Net monthly earning</summary>
        ...
        /// <summary>Code of interval net monthly earning - CM Codebook of net month earnings - EP_C_NET_MONTH_EARNING</summary>
        ...
        /// <summary>Saving investment potencial</summary>
    ...
    /// <summary>Customer employment profession and category</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]

    public partial class Employment
    {
        /// <summary>Profession category code - codebook CSC PROF_CAT1, RDM CB_Prof_Cat1</summary>
        ...
        /// <summary>Profession code - codebook CSC PROF_CAT2</summary>
    ...
    /// <summary>Main source of earnings</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]

    public partial class MainSourceOfEarnings
    {
        /// <summary>Code of the source of earnings - CSC codebook ZDROJ_PRIJ</summary>
        [Newtonsoft.Json.JsonProperty("code", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int Code { get; set; }

        /// <summary>Description of the source of earnings- only for code 6 / 'other source'</summary>
    ...
    {
        /// <summary>Code of housing - codebook CB_Housing_Type</summary>
        [Newtonsoft.Json.JsonProperty("code", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        public string Code { get; set; }

        /// <summary>Description of housing - only for code 'OT' / 'other'</summary>
        [Newtonsoft.Json.JsonProperty("description", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Description { get; set; }
    ...
    /// <summary>Customer KYC data</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]
    ...
    /// <summary>Natural person KYC data. Object is only present when customer is type of NaturalPerson.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]

    public partial class NaturalPersonKyc
    {
        /// <summary>Code of education - codebook CB_EducationDegree</summary>
    ...
    /// <summary>Juridical person KYC data. Object is only present when customer is type of JuridicalPerson.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]
    ...
    /// <summary>Information about political exposure</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.6.3.0 (Newtonsoft.Json v13.0.0.0)")]

    public partial class PoliticalExposition
    {
        /// <summary>Code of political office. Value must match CB_PoliticallyExposedPersonFunction code list</summary>
        ...
        /// <summary>Text description of the function. Description is mandatory when the function code is set to a value that has the mandatory_note flag set to true in the CB_PoliticallyExposedPersonFunction code list.</summary>
        ...
        /// <summary>Risk level of a politically exposed person. Value from code list CB_PoliticallyExposedPersonLevel</summary>
        ...
        /// <summary>Status of politically exposed person. The value should match the code list CB_PoliticallyExposedPersonStatus. Two values are defined ACTIVE - if in office and PASSIVE - should be set three years after the end of public office.</summary>
        [Newtonsoft.Json.JsonProperty("statusCode", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Required(AllowEmptyStrings = true)]
        [System.ComponentModel.DataAnnotations.StringLength(1)]
        ...
        /// <summary>Date of termination of public office, may even be foreseen for the future. When the date expires, the status should be set to passive.</summary>
