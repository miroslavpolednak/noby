...
#pragma warning disable CA1305 // Specify IFormatProvider
    => new()
    {
        Id = ResourceIdentifier.CreateUser("BM", "Broker", humanUser).ToC4M(),
        CompanyId = ResourceIdentifier.CreateUser("BM", "Broker", humanUser, userInfo.DealerCompanyId?.ToString()).ToC4M()
    };
#pragma warning restore CA1305 // Specify IFormatProvider
    ...
    public static KBGroupPerson ToC4mPerson(this C4mUserInfoData userInfo, Identity humanUser)
        => new()
        {
            Id = ResourceIdentifier.CreateUser("PM", "KBGroupPerson", humanUser, userInfo.PersonId.ToString()).ToC4M(),
