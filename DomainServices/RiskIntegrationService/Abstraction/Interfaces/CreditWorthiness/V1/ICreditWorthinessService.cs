namespace DomainServices.RiskIntegrationService.Abstraction.CreditWorthiness.V1;
...
public interface ICreditWorthinessService
{
    ...
    Task<IServiceCallResult> Calculate(Contracts.CreditWorthiness.V1.CreditWorthinessCalculateRequest request, CancellationToken cancellationToken = default(CancellationToken));
}
