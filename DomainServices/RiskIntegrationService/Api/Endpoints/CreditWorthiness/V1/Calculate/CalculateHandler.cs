...
internal sealed class CalculateHandler
    : IRequestHandler<_V1.CreditWorthinessCalculateRequest, _V1.CreditWorthinessCalculateResponse>
{
    public async Task<_V1.CreditWorthinessCalculateResponse> Handle(_V1.CreditWorthinessCalculateRequest request, CancellationToken cancellation)
    {
        ...
        var requestModel = new _C4M.CreditWorthinessCalculationArguments
        {
            ...
            Households = request.Households!.Select(h => new _C4M.LoanApplicationHousehold
            {
                ...
                ExpensesSummary = (h.ExpensesSummary ?? new _V1.CreditWorthinessExpenses()).ToC4m(),
