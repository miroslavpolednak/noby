...
{
    public static _C4M.LoanApplicationProduct ToC4m(this _V1.CreditWorthinessProduct product, string clusterCode)
        => new()
        {
    ...
    public static List<_C4M.ExpensesSummary> ToC4m(this _V1.CreditWorthinessExpenses expenses)
    ...
    public static List<_C4M.LoanApplicationCounterParty> ToC4m(this List<_V1.CreditWorthinessCustomer> clients,
        int mandantId,
    ...
    #region liabilities
    public static List<_C4M.CreditLiabilitiesSummaryHomeCompany> ToC4mCreditLiabilitiesSummary(this List<_V1.CreditWorthinessObligation>? liabilites, IEnumerable<CodebookService.Contracts.Endpoints.ObligationTypes.ObligationTypesItem> obligationTypes)
        => obligationTypes
            .Select(t =>
            {
    ...
    public static List<_C4M.CreditLiabilitiesSummary> ToC4mCreditLiabilitiesSummaryOut(this List<_V1.CreditWorthinessObligation>? liabilites, IEnumerable<CodebookService.Contracts.Endpoints.ObligationTypes.ObligationTypesItem> obligationTypes)
        => obligationTypes
            .Select(t =>
            {
                var coll = liabilites?.Where(x => x.ObligationTypeId == t.Id && x.IsObligationCreditorExternal).ToList();
    ...
    public static List<_C4M.InstallmentsSummaryHomeCompany> ToC4mInstallmentsSummary(this List<_V1.CreditWorthinessObligation>? liabilites, IEnumerable<CodebookService.Contracts.Endpoints.ObligationTypes.ObligationTypesItem> obligationTypes)
        => obligationTypes
            .Select(t =>
            {
                var coll = liabilites?.Where(x => x.ObligationTypeId == t.Id && !x.IsObligationCreditorExternal).ToList();
    ...
    public static List<_C4M.InstallmentsSummaryOutHomeCompany> ToC4mInstallmentsSummaryOut(this List<_V1.CreditWorthinessObligation>? liabilites, IEnumerable<CodebookService.Contracts.Endpoints.ObligationTypes.ObligationTypesItem> obligationTypes)
        => obligationTypes
            .Select(t =>
            {
                var coll = liabilites?.Where(x => x.ObligationTypeId == t.Id && x.IsObligationCreditorExternal).ToList();
