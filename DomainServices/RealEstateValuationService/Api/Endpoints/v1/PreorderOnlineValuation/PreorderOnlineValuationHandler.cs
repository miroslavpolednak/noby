...
namespace DomainServices.RealEstateValuationService.Api.Endpoints.v1.PreorderOnlineValuation;
        ...
        : IRequestHandler<PreorderOnlineValuationRequest, Empty>
{
    public async Task<Empty> Handle(PreorderOnlineValuationRequest request, CancellationToken cancellationToken)
    {
        ...
        {
            throw CIS.Core.ErrorCodes.ErrorCodeMapperBase.CreateArgumentException(ErrorCodeMapper.AddressPointIdNotFound);
        }
        ...
        CancellationToken cancellationToken)
    {
        ...
        throw CIS.Core.ErrorCodes.ErrorCodeMapperBase.CreateValidationException(ErrorCodeMapper.LuxpiKbModelStatusFailed);
    }
}
