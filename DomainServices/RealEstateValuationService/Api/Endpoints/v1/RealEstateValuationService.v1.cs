...
namespace DomainServices.RealEstateValuationService.Api.Endpoints.v1;
        ...
        : Contracts.v1.RealEstateValuationService.RealEstateValuationServiceBase
{
    ...
    public override async Task<Empty> OrderStandardValuation(OrderStandardValuationRequest request, ServerCallContext context)
        => await _mediator.Send(request, context.CancellationToken);
