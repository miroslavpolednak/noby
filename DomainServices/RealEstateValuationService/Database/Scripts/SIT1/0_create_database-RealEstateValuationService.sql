...
CREATE DATABASE [RealEstateValuationService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'RealEstateValuationService', FILENAME = N'F:\MSSQL15.SIT\MSSQL\DATA\RealEstateValuationService.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'RealEstateValuationService_log', FILENAME = N'G:\MSSQL15.SIT\MSSQL\Data\RealEstateValuationService_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
