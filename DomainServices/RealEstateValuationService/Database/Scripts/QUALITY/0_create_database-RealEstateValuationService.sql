...
CREATE DATABASE [RealEstateValuationService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'RealEstateValuationService', FILENAME = N'H:\MSSQL15.QUALITY\MSSQL\Data_Silver_18_QUA\RealEstateValuationService.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'RealEstateValuationService_log', FILENAME = N'H:\MSSQL15.QUALITY\MSSQL\Data_Silver_16_QUA\RealEstateValuationService_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
