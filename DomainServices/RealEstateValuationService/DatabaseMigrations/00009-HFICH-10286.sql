...
update [DDS].[RealEstateValuationOrderData] set [Data]=replace([Data],',"OnlinePreorder":null', '') where [Data] like '%,"OnlinePreorder":null%';
update [DDS].[RealEstateValuationOrderData] set [Data]=replace([Data],'{"Version":1,', '{') where [Data] like '{"Version":1,%';
update [DDS].[RealEstateValudationData] set [Data]=replace([Data],'{"Version":1,', '{') where [Data] like '{"Version":1,%';
GO
