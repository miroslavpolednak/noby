...
CREATE DATABASE [CaseService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'CaseService', FILENAME = N'F:\MSSQL15.MSSQLSERVER\MSSQL\DATA\CaseService.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'CaseService_log', FILENAME = N'G:\MSSQL15.MSSQLSERVER\MSSQL\Data\CaseService_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
