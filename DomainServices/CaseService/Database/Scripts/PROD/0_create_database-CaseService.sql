...
CREATE DATABASE [CaseService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'CaseService', FILENAME = N'S:\Data_Silver_18_SQL\CaseService.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'CaseService_log', FILENAME = N'S:\Data_Silver_16_SQL\CaseService_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
