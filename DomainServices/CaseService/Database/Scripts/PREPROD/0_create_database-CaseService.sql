...
CREATE DATABASE [CaseService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'CaseService', FILENAME = N'R:\Data_Bronze_12_PP\CaseService.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'CaseService_log', FILENAME = N'R:\Data_Silver_07_PP\CaseService_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
