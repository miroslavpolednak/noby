...
## grpcurl tests
        ...
        grpcurl -insecure -d "{\"CaseOwnerUserId\":267,\"Customer\":{\"FirstNameNaturalPerson\":\"John\",\"Name\":\"Doe\"},\"Data\":{\"TargetAmount\":300000,\"ProductInstanceTypeId\":1}}" -H "Authorization: Basic YTph" 127.0.0.1:5080 DomainServices.CaseService.v1.CaseService/CreateCase
        ...
        grpcurl -insecure -d "{\"CaseId\":2,\"Data\":{\"ProductInstanceTypeId\":1,\"ContractNumber\":\"1000000001\",\"TargetAmount\":200000}}" -H "Authorization: Basic YTph" 127.0.0.1:5080 DomainServices.CaseService.v1.CaseService/UpdateCaseData
