...
internal class UpdateCaseDataHandler
    : IRequestHandler<Dto.CaseService.UpdateCaseDataMediatrRequest, Google.Protobuf.WellKnownTypes.Empty>
{
    public async Task<Google.Protobuf.WellKnownTypes.Empty> Handle(Dto.CaseService.UpdateCaseDataMediatrRequest request, CancellationToken cancellation)
    {
