...
internal class UpdateCaseCustomerHandler
    : IRequestHandler<Dto.CaseService.UpdateCaseCustomerMediatrRequest, Google.Protobuf.WellKnownTypes.Empty>
{
    public async Task<Google.Protobuf.WellKnownTypes.Empty> Handle(Dto.CaseService.UpdateCaseCustomerMediatrRequest request, CancellationToken cancellation)
    {
