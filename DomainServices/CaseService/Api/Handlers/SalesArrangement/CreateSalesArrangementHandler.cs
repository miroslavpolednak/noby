...
internal class CreateSalesArrangementHandler
    : IRequestHandler<Dto.SalesArrangement.CreateSalesArrangementMediatrRequest, CreateSalesArrangementResponse>
{
    public async Task<CreateSalesArrangementResponse> Handle(Dto.SalesArrangement.CreateSalesArrangementMediatrRequest request, CancellationToken cancellation)
    {
