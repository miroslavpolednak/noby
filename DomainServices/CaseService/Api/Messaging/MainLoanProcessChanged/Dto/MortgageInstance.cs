...
namespace cz.mpss.api.starbuild.mortgage.workflow.processevents.v1.mainloanprocesschanged
{
	...
	public partial class MortgageInstance : global::Avro.Specific.ISpecificRecord
	{
		...
		private cz.mpss.api.starbuild.mortgage.workflow.processevents.v1.mainloanprocesschanged.StarbuildInstanceId _Starbuild;
		...
		public cz.mpss.api.starbuild.mortgage.workflow.processevents.v1.mainloanprocesschanged.StarbuildInstanceId Starbuild
		{
			get
			{
		...
		public virtual void Put(int fieldPos, object fieldValue)
		{
			switch (fieldPos)
			{
			case 0: this.Starbuild = (cz.mpss.api.starbuild.mortgage.workflow.processevents.v1.mainloanprocesschanged.StarbuildInstanceId)fieldValue; break;
