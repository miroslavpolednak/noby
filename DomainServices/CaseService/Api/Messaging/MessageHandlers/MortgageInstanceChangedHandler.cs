...
internal class MortgageInstanceChangedHandler : IMessageHandler<cz.kb.api.mortgageservicingevents.v2.MortgageInstanceChanged>
{
    ...
    public async Task Handle(IMessageContext context, cz.kb.api.mortgageservicingevents.v2.MortgageInstanceChanged message)
    {
