...
internal class MortgageApplicationChangedHandler : IMessageHandler<cz.kb.api.mortgageservicingevents.v2.MortgageApplicationChanged>
{
    ...
    public async Task Handle(IMessageContext context, cz.kb.api.mortgageservicingevents.v2.MortgageApplicationChanged message)
    {
