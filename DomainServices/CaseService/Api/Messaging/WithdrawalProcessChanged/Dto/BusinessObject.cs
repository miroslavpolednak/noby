...
namespace cz.mpss.api.starbuild.mortgageworkflow.mortgageprocessevents.v1.withdrawalprocesschanged
{
	...
	public partial class BusinessObject : global::Avro.Specific.ISpecificRecord
	{
		...
		private cz.mpss.api.starbuild.mortgageworkflow.mortgageprocessevents.v1.withdrawalprocesschanged.WithdrawalProcessData _withdrawalProcessData;
		...
		public cz.mpss.api.starbuild.mortgageworkflow.mortgageprocessevents.v1.withdrawalprocesschanged.WithdrawalProcessData withdrawalProcessData
		{
			get
			{
				return this._withdrawalProcessData;
			}
			set
			{
				this._withdrawalProcessData = value;
			}
		}
		public virtual object Get(int fieldPos)
		{
			switch (fieldPos)
			{
			case 0: return this.withdrawalProcessData;
		...
		public virtual void Put(int fieldPos, object fieldValue)
		{
			switch (fieldPos)
			{
			case 0: this.withdrawalProcessData = (cz.mpss.api.starbuild.mortgageworkflow.mortgageprocessevents.v1.withdrawalprocesschanged.WithdrawalProcessData)fieldValue; break;
