...
namespace cz.kb.api.mortgageservicingevents.v3.mortgageapplication
{
	...
	public partial class AccountNumber : global::Avro.Specific.ISpecificRecord
	{
		public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse("{\"type\":\"record\",\"name\":\"AccountNumber\",\"doc\":\"AccountNumber: .AccountNumberPrefi" +
				...
				"rtgageapplication\",\"fields\":[{\"name\":\"bankCode\",\"doc\":\"Bank code: 4 digits; cont" +
				"ains values from \'Directory of payment system codes\' by CNB (https://www.cnb.cz/" +
				"en/payments/accounts-bank-codes/); e.g.: for \'1234-567890/0100\' the bank code is" +
				" \'0100\';. CDM attribute class name: AccountNumberCNBBankCode. Attribute has simp" +
				"le type ST_BankCode with description: Kod banky.\",\"type\":{\"type\":\"string\",\"avro." +
				"java.string\":\"String\",\"pattern\":\"^.{0,4}$\"}},{\"name\":\"core\",\"doc\":\"Core/base of " +
				"account number (i.e. the number without the bank code and without prefix): 2 to " +
				"10 digits; mandatory; e.g.: for \'1234-567890/0100\' the core is \'567890\';. CDM at" +
				"tribute class name: AccountNumberCNBCore. Attribute has simple type ST_AccountNu" +
				"mberCore with description: Cislo uctu bez prefixu.An account number excluding a " +
				"prefix.\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"pattern\":\"0*[1-9][" +
				"0-9]*[1-9][0-9]*\"}},{\"name\":\"iban\",\"doc\":\"IBAN representation of the account num" +
				"ber: up to 32 characters - XX## #### #### #### #### #### #### ####; first 2 char" +
				"acters - country code; next 2 characters are check digits; rest is country depen" +
				"dent - for CZ&amp;SK - 4 digits bank code, 6 digits prefix, 10 digits core/base " +
				"account number; without blanks for electronic communication; grouped by 4 charac" +
				"ters for user interfaces;. CDM attribute class name: AccountNumberIBANIban. Attr" +
				"ibute has simple type ST_IBAN with description: The International Bank Account N" +
				"umber (IBAN).\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"pattern\":\"[A" +
				"-Z][A-Z][0-9][0-9][0-9A-Z]*\"}},{\"name\":\"prefix\",\"doc\":\"Account number prefix: up" +
				" to 6 digits; optional - could be empty or contain zeroes \'000000\'; e.g.: for \'1" +
				"234-567890/0100\' the prefix is \'1234\';. CDM attribute class name: AccountNumberC" +
				"NBPrefix. Attribute has simple type ST_AccountNumberPrefix with description: Cis" +
				"lo uctu prefix.An account number prefix. \",\"default\":null,\"type\":[\"null\",{\"type\"" +
				":\"string\",\"avro.java.string\":\"String\",\"pattern\":\"[0-9]*\"}]}]}");
		/// <summary>
