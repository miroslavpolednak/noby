...
namespace cz.kb.api.mortgageservicingevents.v3.mortgageapplication
{
	...
	{
		public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse(@"{""type"":""record"",""name"":""URI"",""doc"":""Uniform Resource IdentifierNapr./typicky http odkaz. CDM entity name(s): URI."",""namespace"":""cz.kb.api.mortgageservicingevents.v3.mortgageapplication"",""fields"":[{""name"":""value"",""doc"":""Complete URI. CDM attribute class name: URIValue. Attribute has simple type ST_URI with description: A string representing a URI. Limited to 2047 characters."",""type"":{""type"":""string"",""avro.java.string"":""String"",""pattern"":""^.{0,2048}$""}}]}");
		/// <summary>
