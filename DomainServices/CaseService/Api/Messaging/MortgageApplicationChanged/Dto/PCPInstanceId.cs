...
namespace cz.kb.api.mortgageservicingevents.v3.mortgageapplication
{
	...
	public partial class PCPInstanceId : global::Avro.Specific.ISpecificRecord
	{
		public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse(@"{""type"":""record"",""name"":""PCPInstanceId"",""doc"":""Multiattribute property of marketable item instance.Multiattribute: Identifiers of marketable item instances are not yet unified, there is no one central catalogue.This also covers identifiers valid for only some part of marketable item instance lifecycle, e.g. proposed product.E.g. PCP identifiers, TSS identifiers.#CZ#Viceatributova promenna instanci prodejnych polozek. Viceatributovost: Identifikatory instanci prodejych polozek zatim nejsou sjednoceny. Neexistujce centralni katalog. Pokryva tez identifikatory, ktere jsou platne pouze pro nektere casti zivotniho cyklu instanci prodejnych polozek (napriklad navrhovany produkt). Priklad: PCP identifikator, TSS identifikator. CDM entity name(s): InstanceId."",""namespace"":""cz.kb.api.mortgageservicingevents.v3.mortgageapplication"",""fields"":[{""name"":""id"",""doc"":""Identifier of product instance item itself.#CZ#Vlastni identifikator instance prodejne polozky. CDM attribute class name: InstanceIdId. Attribute has simple type ST_IdStringDefault with description: Standard data type to be used ID, i.e. unique identifier. It is not supposed to be human-readable.E.g.: AgreementID"",""type"":{""type"":""string"",""avro.java.string"":""String"",""pattern"":""^.{0,30}$""}}]}");
		/// <summary>
		/// Identifier of product instance item itself.#CZ#Vlastni identifikator instance prodejne polozky. CDM attribute class name: InstanceIdId. Attribute has simple type ST_IdStringDefault with description: Standard data type to be used ID, i.e. unique identifier. It is not supposed to be human-readable.E.g.: AgreementID
		/// </summary>
		private string _id;
