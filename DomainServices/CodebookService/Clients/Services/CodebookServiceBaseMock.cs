...
public abstract partial class CodebookServiceBaseMock
{
    ...
    public virtual Task<string> GetACVAndBagmanRealEstateType(int? realEstateStateId, int realEstateSubtypeId, int realEstateTypeId, CancellationToken cancellationToken = default)
        => throw new NotImplementedException();
}
