...
{
    public async Task<List<GenericCodebookItemWithCode>> Handle(LegalCapacitiesRequest request, CancellationToken cancellationToken)
    {
        //TODO dodelat na ciselnik od Asseca az bude
        return new List<GenericCodebookItemWithCode>
        {
