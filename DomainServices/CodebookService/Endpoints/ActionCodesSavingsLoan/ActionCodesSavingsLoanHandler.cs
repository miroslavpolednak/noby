    ...
    : IRequestHandler<ActionCodesSavingsRequest, List<GenericCodebookItem>>
{
    ...
    private const string _sqlQuery =
        "SELECT ID_AKCE_SPO 'Id', NAZEV_AKCE_SPO 'Name', CAST(CASE WHEN PLATNOST_DO_ES IS NULL THEN 1 ELSE 0 END as bit) 'IsActual', CAST(1 as bit) 'IsValid' FROM SBR.AKCE_SPORENI ORDER BY NAZEV_AKCE_SPO ASC";
