...
namespace DomainServices.CodebookService.Endpoints.WorkSectors
{
        ...
        : IRequestHandler<WorkSectorsRequest, List<GenericCodebookItem>>
    {
        ...
        {
            return await FastMemoryCache.GetOrCreate<GenericCodebookItem>(nameof(WorkSectorsHandler), async () => await _connectionProvider.ExecuteDapperRawSqlToList<GenericCodebookItem>(_sqlQuery, cancellationToken));
        }
