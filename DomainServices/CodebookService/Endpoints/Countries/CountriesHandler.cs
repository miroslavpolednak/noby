...
namespace DomainServices.CodebookService.Endpoints.Countries
{
        ...
        : IRequestHandler<CountriesRequest, List<CountriesItem>>
    {
        ...
        {
            return await FastMemoryCache.GetOrCreate<CountriesItem>(nameof(CountriesHandler), async () => await _connectionProvider.ExecuteDapperRawSqlToList<CountriesItem>(_sqlQuery, cancellationToken));
        }
