    ...
    : IRequestHandler<ActionCodesSavingsLoanRequest, List<GenericCodebookItem>>
{
    ...
    private const string _sqlQuery =
        "SELECT ID_AKCE_UV 'Id', NAZEV_AKCE_UV 'Name', CAST(CASE WHEN PLATNOST_DO_ES IS NULL THEN 1 ELSE 0 END as bit) 'IsActual', CAST(1 as bit) 'IsValid' FROM [SBR].[AKCE_UV] ORDER BY NAZEV_AKCE_UV ASC";
