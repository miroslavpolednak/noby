    ...
    : IRequestHandler<RealEstatePurchaseTypesRequest, List<RealEstatePurchaseTypeItem>>
{
    ...
    private const string _sqlQuery =
        "SELECT KOD 'Id', POPIS 'Name', CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], '9999-12-31') THEN 1 ELSE 0 END 'IsValid', DEF 'IsDefault', PORADI 'ORDER', CODE 'Code', NULLIF(MANDANT, 0) 'MandantId' FROM [SBR].[CIS_UCEL_PORIZENI_UV] ORDER BY PORADI ASC";
