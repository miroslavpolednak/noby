...
CREATE DATABASE [CodebookService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'CodebookService', FILENAME = N'F:\MSSQL15.MSSQLSERVER\MSSQL\DATA\CodebookService.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'CodebookService_log', FILENAME = N'G:\MSSQL15.MSSQLSERVER\MSSQL\Data\CodebookService_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
