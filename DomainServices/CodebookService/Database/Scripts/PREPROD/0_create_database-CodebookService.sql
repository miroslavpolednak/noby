...
CREATE DATABASE [CodebookService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'CodebookService', FILENAME = N'R:\Data_Bronze_12_PP\CodebookService.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'CodebookService_log', FILENAME = N'R:\Data_Silver_07_PP\CodebookService_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
