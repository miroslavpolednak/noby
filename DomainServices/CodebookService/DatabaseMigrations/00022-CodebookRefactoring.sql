...
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'ClassificationOfEconomicActivities', N'SELECT KOD ''Id'', TEXT ''Name'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_OKEC] ORDER BY KOD ASC', 1)
GO
...
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'ContactTypes1', N'SELECT TYP_KONTAKTU ''Id'', TEXT ''Name'', NULLIF(MANDANT, 0) ''MandantId'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_TYPY_KONTAKTOV] ORDER BY TYP_KONTAKTU ASC', 1)
GO
...
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'DrawingDurations', N'SELECT KOD ''Id'', LHUTA_K_CERPANI ''DrawingDuration'', DEF ''IsDefault'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_LHUTA_K_CERPANI] ORDER BY KOD ASC', 1)
GO
...
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'EducationLevels', N'SELECT KOD ''Id'', TEXT ''Name'', CODE_NAME ''ShortName'', CODE ''RdmCode'',  KOD_SCORING ''ScoringCode'', CAST(CASE WHEN PLATNY_PRE_ES = 1 AND SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_VZDELANIE] WHERE MANDANT IN (0, 2) ORDER BY KOD ASC', 1)
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'EmploymentTypes', N'SELECT Kod ''Id'', CODE ''Code'', TEXT ''Name'', CAST(CASE WHEN SYSDATETIME() BETWEEN PLATNOST_OD AND ISNULL(PLATNOST_DO, ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM SBR.CIS_PRACOVNY_POMER ORDER BY Kod', 1)
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'Fees', N'SELECT POPLATEK_ID ''Id'', POPLATEK_ID_KB ''IdKb'', NULLIF(MANDANT, 0) ''MandantId'', TEXT ''ShortName'', TEXT_DOKUMENTACE ''Name'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_POPLATKY_UV_DEF] ORDER BY POPLATEK_ID ASC', 1)
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'FixedRatePeriods', N'SELECT KOD_PRODUKTU ''ProductTypeId'', PERIODA_FIXACE ''FixedRatePeriod'', NULLIF(MANDANT, 0) ''MandantId'', NOVY_PRODUKT ''IsNewProduct'', ALGORITMUS_SAZBY ''InterestRateAlgorithm'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM SBR.CIS_PERIODY_FIXACE_V', 1)
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'FormTypes', N'SELECT FORMULAR_ID ''Id'', CISLO ''Type'', VERZE ''Version'', NAZEV ''Name'', NULLIF(MANDANT, 0) ''MandantId'', CAST(CASE WHEN SYSDATETIME() BETWEEN PLATNOST_OD AND ISNULL(PLATNOST_DO, ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_FORMULARE] ORDER BY FORMULAR_ID ASC', 1)
GO
...
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'HousingConditions', N'SELECT KOD ''Id'', TEXT ''Name'', CODE ''Code'', CODE ''RdmCode'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_FORMA_BYVANIA] ORDER BY KOD ASC', 1)
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'Channels1', N'SELECT KOD ''Id'', TEXT ''Name'', NULLIF(MANDANT, 0) ''MandantId'', CODE ''Code'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_ALT_KANALY] ORDER BY KOD ASC', 1)
GO
...
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'IncomeForeignTypes', N'SELECT KOD ''Id'', CODE ''Code'', TEXT ''Name'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_PRIJEM_ZO_ZAHRANICIA] ORDER BY KOD ASC', 1)
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'IncomeMainTypes', N'SELECT KOD ''Id'', CODE ''Code'', TEXT ''Name'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_ZDROJ_PRIJMU_HLAVNI] ORDER BY KOD ASC', 1)
GO
...
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'IncomeOtherTypes', N'SELECT KOD ''Id'', CODE ''Code'', TEXT_CZE ''Name'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_ZDROJ_PRIJMU_VEDLAJSI] ORDER BY KOD ASC', 1)
GO
...
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'LoanPurposes', N'SELECT CAST(KOD as int) ''Id'', TEXT ''Name'', CAST(NULLIF(MANDANT, 0) as int) ''MandantId'', KOD_UVER ''ProductTypeIds'', CAST(PORADI as int) ''Order'', CAST(MAPOVANI_C4M as int) ''C4MId'', CAST(CASE WHEN SYSDATETIME() BETWEEN [DATUM_PLATNOSTI_OD] AND ISNULL([DATUM_PLATNOSTI_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM SBR.CIS_UCEL_UVERU_INT1 ORDER BY KOD', 1)
GO
...
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'MarketingActions', N'SELECT KOD_MA_AKCIE ''Id'', TYP_AKCIE ''Code'', NULLIF(MANDANT, 0) ''MandantId'', NAZOV ''Name'', POPIS ''Description'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_MA_AKCIE] ORDER BY KOD_MA_AKCIE ASC', 1)
GO
...
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'ObligationCorrectionTypes', N'SELECT KOD ''Id'', TEXT ''Name'', CAST(CASE WHEN SYSDATETIME() BETWEEN PLATNOST_OD AND ISNULL(PLATNOST_DO, ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'', CODE ''Code'' FROM SBR.CIS_KOREKCE_ZAVAZKU ORDER BY KOD', 1)
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'ObligationLaExposures', N'SELECT KOD ''Id'', CODE ''RdmCode'', TEXT ''Name'', DRUH_ZAVAZKU_KATEGORIE ''ObligationTypeId'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].CIS_ZAVAZKY_LA_EXPOSURE ORDER BY KOD ASC', 1)
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'ObligationTypes1', N'SELECT KOD ''Id'', CODE ''Code'', TEXT ''Name'', KOREKCE_ZAVAZKU ''ObligationCorrectionTypeId'', PORADIE ''Order'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].CIS_DRUH_ZAVAZKU ORDER BY KOD ASC', 1)
GO
...
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'ProfessionTypes', N'SELECT KOD ''Id'',  ID_CM ''RdmCode'', NAZEV_CM ''Name'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_POVOLANI] ORDER BY KOD ASC', 1)
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'ProofTypes', N'SELECT KOD ''Id'', CODE ''Code'', TEXT_CZE ''Name'', TEXT_ENG ''NameEnglish'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_TYP_POTVRDENIE_PRIJMU] ORDER BY KOD ASC', 1)
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'PropertySettlements', N'SELECT CAST(KOD as int) ''Id'', TEXT_CZE ''Name'', TEXT_ENG ''NameEnglish'', ISNULL(ROD_STAV,'''') ''MaritalStateId'', CAST(PORADI as int) ''Order'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_VYPORADANI_MAJETKU] ORDER BY KOD ASC', 1)
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'RealEstatePurchaseTypes', N'SELECT CAST(KOD as int) ''Id'', POPIS ''Name'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'', DEF ''IsDefault'', PORADI ''Order'', CODE ''Code'', NULLIF(MANDANT, 0) ''MandantId'' FROM [SBR].[CIS_UCEL_PORIZENI_UV] ORDER BY PORADI ASC', 1)
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'RealEstateTypes', N'SELECT CAST(KOD as int) ''Id'', POPIS ''Name'', NULLIF(MANDANT, 0) ''MandantId'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'', DEF ''IsDefault'', CAST(PORADI as int) ''Order'' FROM [SBR].[CIS_TYPY_NEHNUTELNOSTI_UV] ORDER BY PORADI ASC', 1)
GO
...
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'StatementFrequencies', N'SELECT KOD ''Id'', CODE ''FrequencyCode'', FREQ ''FrequencyValue'', SORT ''Order'', [TEXT] ''Name'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'', DEF ''IsDefault'' FROM [SBR].[CIS_HU_VYPIS_FREQ] ORDER BY SORT', 1)
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'StatementSubscriptionTypes', N'SELECT KOD ''Id'', CODE ''Code'', [TEXT] ''Name'', CAST(CASE WHEN SYSDATETIME() BETWEEN[PLATNOST_OD] AND ISNULL([PLATNOST_DO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'', DEF ''IsDefault'' FROM [SBR].[CIS_HU_ZODB_VYPIS]', 1)
GO
INSERT [dbo].[SqlQuery] ([SqlQueryId], [SqlQueryText], [DatabaseProvider]) VALUES (N'StatementTypes', N'SELECT KOD ''Id'', C_POPIS_R_CZ ''Name'', C_POPIS_CZ ''ShortName'', N_SORT_ORDER ''Order'', CAST(CASE WHEN SYSDATETIME() BETWEEN[VALID_FROM] AND ISNULL([VALID_TO], ''9999-12-31'') THEN 1 ELSE 0 END as bit) ''IsValid'' FROM [SBR].[CIS_HU_TYP_VYPIS] ORDER BY KOD ASC', 1)
GO
