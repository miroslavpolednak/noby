...
internal static class StartupExtensions
{
    public static WebApplicationBuilder AddCustomerService(this WebApplicationBuilder builder)
    {
        ...
        builder.AddExternalService<ExternalServices.Contacts.V1.IContactClient>();
        ...
        builder.AddExternalService<ExternalServices.Address.V2.ICustomerAddressServiceClient>();
