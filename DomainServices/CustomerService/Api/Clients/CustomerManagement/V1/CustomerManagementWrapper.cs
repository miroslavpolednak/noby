...
namespace DomainServices.CustomerService.Api.Clients.CustomerManagement.V1
{
    ...
    internal partial class CustomerManagementWrapper 
    {
        ...
        /// </summary>
        /// <remarks>
        /// Operation returns customer base information with: party, primary address, contact address, primary identification document, primary email and phone.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Operation search customers according input parameters
        /// </remarks>
        ...
        public virtual async System.Threading.Tasks.Task<CustomerSearchResult> SearchCustomerAsync(int? numberOfEntries, long? customerId, string name, string firstName, System.DateTime? birthEstablishedDate, string identifierValue, string identifierTypeCode, string idDocumentTypeCode, string idDocumentNumber, string idDocumentIssuingCountryCode, string email, string phoneNumber, bool? isInKbi, System.Collections.Generic.IEnumerable<Anonymous> legalStatusCode, bool? includeArchived, bool? showSegment, bool? showOnlyIdentified, string x_B3_TraceId, string x_KB_Caller_System_Identity, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (showOnlyIdentified != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("showOnlyIdentified") + "=").Append(System.Uri.EscapeDataString(ConvertToString(showOnlyIdentified, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
        ...
        /// </summary>
        /// <remarks>
        /// Operation returns basic personal data for natural person with vocative for first name and surname
        /// </remarks>
        /// <param name="customerId">Identifier of the customer whose base information will be returned (KBID - identifier of customer in Customer Management system)</param>
        /// <param name="showFirstNameVocative">flag indicating whether first name vocative should be evalueted and returned</param>
        /// <param name="showSurnameVocative">flag indicating whether surname vocative should be evalueted and returned</param>
    ...
    public partial class TaxResidence
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("residenceCountries", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.Required]
    ...
    public partial class TaxResidenceCountry
    {
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("tinMissingReasonDescription", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [System.ComponentModel.DataAnnotations.StringLength(200, MinimumLength = 1)]
