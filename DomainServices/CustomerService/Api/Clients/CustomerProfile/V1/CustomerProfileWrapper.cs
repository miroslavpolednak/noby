...
namespace DomainServices.CustomerService.Api.Clients.CustomerProfile.V1
{
    ...
    public partial class CustomerProfileWrapper 
    {
        private string _baseUrl = "https://cm-dev.kb.cz/be-cm/api";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public CustomerProfileWrapper(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// </summary>
        /// <param name="customerId">Identifier of the customer for whom profile validation is performed. (KBID - identifier of customer in Customer Management system)</param>
        /// <param name="profileCode">Customer profile code</param>
        ...
        public virtual System.Threading.Tasks.Task<ValidateCustomerProfileResponse> ValidateCustomerProfileAsync(long customerId, string profileCode, string x_B3_TraceId, string x_KB_Party_Identity_In_Service, string x_KB_Orig_System_Identity, string x_KB_Caller_System_Identity)
        {
            return ValidateCustomerProfileAsync(customerId, profileCode, x_B3_TraceId, x_KB_Party_Identity_In_Service, x_KB_Orig_System_Identity, x_KB_Caller_System_Identity, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ValidateCustomerProfileResponse> ValidateCustomerProfileAsync(long customerId, string profileCode, string x_B3_TraceId, string x_KB_Party_Identity_In_Service, string x_KB_Orig_System_Identity, string x_KB_Caller_System_Identity, System.Threading.CancellationToken cancellationToken)
        {
            if (customerId == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ValidateCustomerProfileResponse>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    public partial class Domain
    {
        ...
        [Newtonsoft.Json.JsonProperty("issueCodes", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
