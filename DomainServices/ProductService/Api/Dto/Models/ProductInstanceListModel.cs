...
internal sealed class ProductInstanceListModel
{
    ...
    public Contracts.ProductInstanceListItem CreateContractItem(List<DomainServices.CodebookService.Contracts.Endpoints.ProductInstanceTypes.ProductTypeItem> productTypes)
    {
