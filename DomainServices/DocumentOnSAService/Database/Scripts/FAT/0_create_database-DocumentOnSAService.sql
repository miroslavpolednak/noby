...
CREATE DATABASE [DocumentOnSAService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DocumentOnSAService', FILENAME = N'F:\MSSQL15.FAT\MSSQL\DATA\DocumentOnSAService.mdf' , SIZE = 73728KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DocumentOnSAService_log', FILENAME = N'G:\MSSQL15.FAT\MSSQL\Data\DocumentOnSAService_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
