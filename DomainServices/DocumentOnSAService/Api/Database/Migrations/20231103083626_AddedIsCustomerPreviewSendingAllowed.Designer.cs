...
namespace DomainServices.DocumentOnSAService.Api.Database.Migrations
{
    ...
    [Migration("20231103083626_AddedIsCustomerPreviewSendingAllowed")]
    partial class AddedIsCustomerPreviewSendingAllowed
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DomainServices.DocumentOnSAService.Api.Database.Entities.DocumentOnSa", b =>
                {
                    ...
                    b.Property<bool>("IsCustomerPreviewSendingAllowed")
                        .HasColumnType("bit");
