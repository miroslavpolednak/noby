    ...
    : IOfferServiceClient
{
    ...
    public async Task DeleteOffers(IEnumerable<int> offerIds, CancellationToken cancellationToken = default)
        => await _service.DeleteOffersAsync(new DeleteOffersRequest
        {
            OfferIds = { offerIds }
        }, cancellationToken: cancellationToken);
