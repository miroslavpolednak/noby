/****** Object:  StoredProcedure [dbo].[DeleteRefixationOfferOlderThan]    Script Date: 26.04.2024 11:04:57 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER   PROC [dbo].[DeleteRefixationOfferOlderThan] 
  @Date DATE
AS
BEGIN
BEGIN TRANSACTION;
...
INTO #ForDelete
FROM dbo.Offer o
WHERE o.ValidTo < @Date AND o.OfferType = 2 --OfferType 2 > Refixation 
...
END
GO
/****** Object:  StoredProcedure [dbo].[DeleteRefixationOffer]    Script Date: 26.04.2024 12:44:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
/****** Script for SelectTopNRows command from SSMS  ******/
ALTER   PROC [dbo].[DeleteRefixationOffer] 
  @FlagState INT,
  @BatchId BIGINT
AS
BEGIN
...
END
GO
/****** Object:  StoredProcedure [dbo].[UpdateCustomerInformation]  Script Date: 26.04.2024 12:44:45 ******/
CREATE OR ALTER PROC [dbo].[UpdateCustomerInformation] 
  @BatchId BIGINT
AS
BEGIN
BEGIN TRANSACTION;
...
k.CaseId AS CaseId,
oin.Account_Nbr AS Account_Nbr,
oin.Leave_Probability AS Case_Customer_Churn_Risk,
oin.Calculated_Delta AS Case_Customer_Price_Sensitivity
INTO #PairedCaseId
FROM bdp.D_CUST_RETENTION_ACCOUNT oin 
INNER JOIN dbo.CaseIdAccountNumberKonstDb k ON k.AreaCodeAccountNumber = oin.Account_Nbr 
WHERE oin.Batch_Id = @BatchId
...
INNER JOIN #PairedCaseId p ON c.CaseId = p.CaseId
...
END
GO
/****** Object:  StoredProcedure [dbo].[ImportDataFromDatamart]    Script Date: 26.04.2024 12:48:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
