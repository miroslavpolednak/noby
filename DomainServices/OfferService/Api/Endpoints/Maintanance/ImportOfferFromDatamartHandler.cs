...
public class ImportOfferFromDatamartHandler(IConfiguration config) : IRequestHandler<ImportOfferFromDatamartRequest, Empty>
{
    private const int _technicalTimeout = 500;
        ...
        CancellationToken cancellationToken)
    {
        ...
        while (await connection.ExecuteScalarAsync<int>(_existBatchForProcessingSql) > 0 && maxAllowedBatchPerJob > 0)
        {
            ...
            //Delete all non Communicated refixation offer from datalake
