...
CREATE DATABASE [OfferService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'OfferService', FILENAME = N'F:\MSSQL15.SIT\MSSQL\DATA\OfferService.mdf' , SIZE = 73728KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'OfferService_log', FILENAME = N'G:\MSSQL15.SIT\MSSQL\Data\OfferService_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
