...
CREATE DATABASE [DocumentArchiveService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DocumentArchiveService', FILENAME = N'S:\Data_Silver_18_SQL\DocumentArchiveService.mdf' , SIZE = 73728KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DocumentArchiveService_log', FILENAME = N'S:\Data_Silver_16_SQL\DocumentArchiveService_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
