...
CREATE DATABASE [DocumentArchiveService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DocumentArchiveService', FILENAME = N'R:\Data_Bronze_12_PP\DocumentArchiveService.mdf' , SIZE = 73728KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DocumentArchiveService_log', FILENAME = N'R:\Data_Silver_07_PP\DocumentArchiveService_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
