...
CREATE DATABASE [DocumentArchiveService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DocumentArchiveService', FILENAME = N'F:\MSSQL15.MSSQLSERVER\MSSQL\DATA\DocumentArchiveService.mdf' , SIZE = 73728KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DocumentArchiveService_log', FILENAME = N'G:\MSSQL15.MSSQLSERVER\MSSQL\Data\DocumentArchiveService_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
