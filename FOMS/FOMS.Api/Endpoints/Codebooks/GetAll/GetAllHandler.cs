    ...
    : IRequestHandler<GetAllRequest, List<GetAllResponseItem>>
{
    ...
    private async Task<GetAllResponseItem> fillCodebook(string code, string original, CancellationToken cancellationToken)
        => code switch
        {
            ...
            "incomeabroadtypes" => new(original, await _codebooks.IncomeForeignTypes(cancellationToken)),
            ...
            "propertysettlement" => new(original, await _codebooks.PropertySettlements(cancellationToken)),
