...
public class CreditWorthinessHouseholdService
{
    public async Task<_Rip.CreditWorthinessHousehold> CreateHousehold(_SA.Household household, CancellationToken cancellationToken)
    {
