    ...
    : AsyncRequestHandler<SignInRequest>
{
    ...
    public SignInHandler(ILogger<SignInHandler> logger, DomainServices.UserService.Clients.IUserServiceAbstraction userService, IHttpContextAccessor httpContext)
    {
