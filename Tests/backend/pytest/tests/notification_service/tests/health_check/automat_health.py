...
discovery_health_test_file_path = 'discovery_health.py'
...
for url in urls:
    destination_file_path = f"{url}_health_checks.py"
...
subprocess.call(['pytest', *destination_file_paths, discovery_health_test_file_path, "--html-report=" + report_path, "--title=" + report_title])
