...
public static class GrpcValidationExtensions
{
    ...
    public static IRuleBuilderOptions<TRequest, TElement> ThrowCisException<TRequest, TElement>(this IRuleBuilderOptions<TRequest, TElement> builder, GrpcValidationBehaviorExeptionTypes exceptionType)
