...
{
    public sealed class CisServiceAuthenticationHandler : AuthenticationHandler<CisServiceAuthenticationOptions>
    {
        ...
        private async Task<bool> authenticateUser(string login, string password)
        {
            ...
            {
                _logger.LogDebug("AD validation failed for '{Login}'", login);
                return false;
            }
        }
    }
