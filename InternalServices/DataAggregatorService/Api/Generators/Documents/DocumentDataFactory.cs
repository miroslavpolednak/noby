using CIS.InternalServices.DataAggregatorService.Api.Generators.Documents.TemplateData;
using CIS.InternalServices.DataAggregatorService.Api.Generators.Documents.VersionData;
...
internal class DocumentDataFactory
{
    ...
    public AggregatedData CreateData(DocumentTypes documentType) =>
        documentType switch
        {
            ...
            DocumentTypes.ODSTOUP => _serviceProvider.GetRequiredService<ApplicationTerminationTemplateData>(),
