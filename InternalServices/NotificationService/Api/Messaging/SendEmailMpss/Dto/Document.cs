...
namespace cz.mpss.api.noby.notification.sendapi.v1
{
	...
	public partial class Document : global::Avro.Specific.ISpecificRecord
	{
		public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse("{\"type\":\"record\",\"name\":\"Document\",\"doc\":\"Dokument z DMSX. Identifikovan je pres " +
				...
				"amespace\":\"cz.mpss.api.noby.notification.sendapi.v1\",\"fields\":[{\"name\":\"fileExte" +
				"nsion\",\"doc\":\"File extension of document content stored.E.g. exe, pdf, docx. CDM" +
				" attribute class name: DocumentContentFileExtension. Codebook type: CB_FileExten" +
				"sion.\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"id\",\"doc\":" +
				"\"Unique identifier of document. Does not change with document version. Multi ide" +
				"ntifier.Jednoznacny identifikator dokumentu. DMS: ChronicleID, RootDocID. Pokud " +
				"je dokument vkladany do DMS uprostred sveho zivotniho cyklu, je zadouci, aby kon" +
				"zument pri jeho ulozeni vyplnoval docId v pripade, ze vyhovuje formatu = cerpa z" +
				"e stejne rady IGS docId.Escudo:. CDM attribute class name: DocumentIdId.\",\"type\"" +
				":{\"type\":\"string\",\"avro.java.string\":\"String\",\"pattern\":\"^.{0,30}$\"}},{\"name\":\"v" +
				"ersion\",\"doc\":\"Version of document. Only contains identifier of version, e.g 14C" +
				"alled \'business\' version, as this document version must be increased by explicit" +
				" consumer.Ciselne oznaceni verze v kompetenci DMS. Viz INS 22-011. CDM attribute" +
				" class name: DocumentVersionVersion.\",\"default\":null,\"type\":[\"null\",\"int\"]}]}");
		/// <summary>
