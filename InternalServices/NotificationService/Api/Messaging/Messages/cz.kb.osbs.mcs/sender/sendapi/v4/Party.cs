...
namespace cz.kb.osbs.mcs.sender.sendapi.v4
{
	...
	public partial class Party : global::Avro.Specific.ISpecificRecord
	{
		...
		public cz.kb.osbs.mcs.sender.sendapi.v4.LegalPerson legalPerson
		{
			get
			{
		...
		public cz.kb.osbs.mcs.sender.sendapi.v4.NaturalPerson naturalPerson
		{
			get
			{
		...
		public virtual void Put(int fieldPos, object fieldValue)
		{
			switch (fieldPos)
			{
			case 0: this.legalPerson = (cz.kb.osbs.mcs.sender.sendapi.v4.LegalPerson)fieldValue; break;
			case 1: this.naturalPerson = (cz.kb.osbs.mcs.sender.sendapi.v4.NaturalPerson)fieldValue; break;
