...
namespace cz.kb.osbs.mcs.sender.sendapi.v4.sms
{
	...
	public partial class SendSMS : global::Avro.Specific.ISpecificRecord
	{
		public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse("{\"type\":\"record\",\"name\":\"SendSMS\",\"doc\":\"Represents any content.. ## Activity of " +
				...
				"tring\",\"pattern\":\"^.{0,30}$\"}},{\"name\":\"phone\",\"type\":{\"type\":\"record\",\"name\":\"P" +
				"hone\",\"doc\":\"Phone as a contact on party.. ## Represents telephone number. CDM e" +
				"ntity name(s): PhoneContact,PhoneNumber.\",\"namespace\":\"cz.kb.osbs.mcs.sender.sen" +
				"dapi.v4\",\"fields\":[{\"name\":\"countryCode\",\"doc\":\"Country code of the MSISDN. It i" +
				"s \'CC\' part of msisdn, see belowBy definition, MSISDN is composed of CC+NDC+SN w" +
				"here<ul>\\t<li>CC stands for \'Country Code\'</li>\\t<li>NDC stands for \'National De" +
				"stination Code\'</li>\\t<li>SN stands for \'Subscriber Name\'</li></ul>E.g.: 420. CD" +
				"M attribute class name: PhoneNumberCountryCode.\",\"type\":{\"type\":\"string\",\"avro.j" +
				"ava.string\":\"String\",\"pattern\":\"^.{0,5}$\"}},{\"name\":\"nationalPhoneNumber\",\"doc\":" +
				"\"Local part of the MSISDN. It is concatenated \'NDC+SN\', see definition below.By " +
				"definition, MSISDN is composed of CC+NDC+SN where<ul>\\t<li>CC stands for \'Countr" +
				"y Code\'</li>\\t<li>NDC stands for \'National Destination Code\'</li>\\t<li>SN stands" +
				" for \'Subscriber Name\'</li></ul>E.g.: 603123456. CDM attribute class name: Phone" +
				"NumberNationalPhoneNumber.\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"," +
				"\"pattern\":\"^.{0,14}$\"}}]}},{\"name\":\"processingPriority\",\"doc\":\"Priority of notif" +
				"ication that determines order in which notification are sent.e.g. high or standa" +
				"rd. CDM attribute class name: NotificationProcessingPriority.\",\"default\":null,\"t" +
				"ype\":[\"null\",\"int\"]},{\"name\":\"text\",\"doc\":\"Content in text format. CDM attribute" +
				" class name: ContentText.\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}" +
				",{\"name\":\"type\",\"doc\":\"Multicodebook attribute type itself. CDM attribute class " +
				"name: NotificationTypeType. Codebook type: CB_MultiCodebookValue.\",\"type\":{\"type" +
				"\":\"string\",\"avro.java.string\":\"String\",\"pattern\":\"^.{0,100}$\"}}],\"javaAnnotation" +
				"\":\"cz.kb.api.common.annotation.ConfluentSchemaRegistryCompatible\"}");
		...
		public virtual void Put(int fieldPos, object fieldValue)
		{
			...
			case 2: this.phone = (cz.kb.osbs.mcs.sender.sendapi.v4.Phone)fieldValue; break;
