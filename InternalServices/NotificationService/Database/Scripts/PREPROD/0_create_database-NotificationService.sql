...
CREATE DATABASE [NotificationService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'NotificationService', FILENAME = N'R:\Data_Bronze_12_PP\NotificationService.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'NotificationService_log', FILENAME = N'R:\Data_Silver_07_PP\NotificationService_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
