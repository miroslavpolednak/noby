...
CREATE DATABASE [NotificationService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'NotificationService', FILENAME = N'F:\MSSQL15.MSSQLSERVER\MSSQL\DATA\NotificationService.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'NotificationService_log', FILENAME = N'G:\MSSQL15.MSSQLSERVER\MSSQL\Data\NotificationService_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
