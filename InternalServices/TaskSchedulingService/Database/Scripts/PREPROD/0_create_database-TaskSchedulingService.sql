...
CREATE DATABASE [TaskSchedulingService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TaskSchedulingService', FILENAME = N'R:\Data_Bronze_12_PP\TaskSchedulingService.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TaskSchedulingService_log', FILENAME = N'R:\Data_Silver_07_PP\TaskSchedulingService_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
