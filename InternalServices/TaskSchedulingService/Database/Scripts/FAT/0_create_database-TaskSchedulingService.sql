...
CREATE DATABASE [TaskSchedulingService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TaskSchedulingService', FILENAME = N'F:\MSSQL15.FAT\MSSQL\DATA\TaskSchedulingService.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TaskSchedulingService_log', FILENAME = N'G:\MSSQL15.FAT\MSSQL\Data\TaskSchedulingService_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
