...
CREATE DATABASE [TaskSchedulingService]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TaskSchedulingService', FILENAME = N'H:\MSSQL15.QUALITY\MSSQL\Data_Silver_18_QUA\TaskSchedulingService.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TaskSchedulingService_log', FILENAME = N'H:\MSSQL15.QUALITY\MSSQL\Data_Silver_16_QUA\TaskSchedulingService_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
