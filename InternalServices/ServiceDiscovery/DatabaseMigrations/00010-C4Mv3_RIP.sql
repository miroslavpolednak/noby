Update [dbo].[ServiceDiscovery] Set
    ...
    ServiceUrl = Case  
                    When EnvironmentName = 'PREPROD' OR EnvironmentName = 'UAT' Then 'https://stage.risk-loan-assessment.kbcloud/kbgroup-laa-credit-worthiness-calculation-service-3/api'
  ...
  Update [dbo].[ServiceDiscovery] Set
    ...
    ServiceUrl = Case  
                    When EnvironmentName = 'PREPROD' OR EnvironmentName = 'UAT' Then 'https://stage.risk-loan-assessment.kbcloud/laa-loan-application-exposure-service-3/api'
  ...
  Update [dbo].[ServiceDiscovery] Set
    ...
    ServiceUrl = Case  
                    When EnvironmentName = 'PREPROD' OR EnvironmentName = 'UAT' Then 'https://stage.risk-loan-assessment.kbcloud/la-loan-application-hf-adapter-service-3/api'
  ...
  Update [dbo].[ServiceDiscovery] Set
    ...
    ServiceUrl = Case  
                    When EnvironmentName = 'PREPROD' OR EnvironmentName = 'UAT' Then 'https://stage.risk-loan-assessment.kbcloud/laa-loan-application-assessment-service-3/api'
  ...
  Update [dbo].[ServiceDiscovery] Set
    ...
    ServiceUrl = Case  
                    When EnvironmentName = 'PREPROD' OR EnvironmentName = 'UAT' Then 'https://stage.risk-loan-assessment.kbcloud/laa-risk-business-case-service-3/api'
  ...
  Update [dbo].[ServiceDiscovery] Set
    ...
    ServiceUrl = Case  
                    When EnvironmentName = 'PREPROD' OR EnvironmentName = 'UAT' Then 'https://stage.risk-loan-assessment.kbcloud/laa-loan-application-risk-chars-calculation-service-2/api'
