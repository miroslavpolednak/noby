...
## grpcurl tests
        ...
        grpcurl -insecure -d "{\"Environment\":\"DEV\"}" -H "Authorization: Basic YTph" -H "noby-user-id: 267" 127.0.0.1:5005 CIS.InternalServices.ServiceDiscovery.v1.DiscoveryService/GetServices
