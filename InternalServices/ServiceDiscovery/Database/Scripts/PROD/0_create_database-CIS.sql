...
CREATE DATABASE [CIS]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'CIS', FILENAME = N'S:\Data_Silver_01_SQL\CIS.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'CIS_log', FILENAME = N'S:\Data_Silver_01_SQL\CIS_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
