...
CREATE DATABASE [CIS]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'CIS', FILENAME = N'H:\Program Files\Microsoft SQL Server\MSSQL15.FAT2\MSSQL\DATA\CIS.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'CIS_log', FILENAME = N'H:\Program Files\Microsoft SQL Server\MSSQL15.FAT2\MSSQL\Data\CIS_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
