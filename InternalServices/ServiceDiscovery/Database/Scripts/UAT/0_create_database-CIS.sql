...
CREATE DATABASE [CIS]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'CIS', FILENAME = N'F:\MSSQL15.UAT1\MSSQL\DATA\CIS.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'CIS_log', FILENAME = N'G:\MSSQL15.UAT1\MSSQL\Data\CIS_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
