...
CREATE DATABASE [CIS]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'CIS', FILENAME = N'R:\Data_Bronze_12_PP\CIS.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'CIS_log', FILENAME = N'R:\Data_Silver_07_PP\CIS_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
