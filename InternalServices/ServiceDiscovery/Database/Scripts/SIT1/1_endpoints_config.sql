...
INSERT [dbo].[ServiceDiscovery] ([EnvironmentName], [ServiceName], [ServiceUrl], [ServiceType], [AddToGlobalHealthCheck]) VALUES (N'SIT1', N'ES:Contacts:V1', N'https://be-cm-v1.fat.custmng.kbcloud/api', 3, 0)
...
INSERT [dbo].[ServiceDiscovery] ([EnvironmentName], [ServiceName], [ServiceUrl], [ServiceType], [AddToGlobalHealthCheck]) VALUES (N'SIT1', N'ES:CustomerManagement:V2', N'https://be-cm-v1.fat.custmng.kbcloud/api', 3, 0)

INSERT [dbo].[ServiceDiscovery] ([EnvironmentName], [ServiceName], [ServiceUrl], [ServiceType], [AddToGlobalHealthCheck]) VALUES (N'SIT1', N'ES:CustomerProfile:V1', N'https://be-cm-v1.fat.custmng.kbcloud/api', 3, 0)
...
INSERT [dbo].[ServiceDiscovery] ([EnvironmentName], [ServiceName], [ServiceUrl], [ServiceType], [AddToGlobalHealthCheck]) VALUES (N'SIT1', N'ES:Kyc:V1', N'https://be-cm-v1.fat.custmng.kbcloud/api', 3, 0)
